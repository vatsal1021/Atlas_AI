...
_PROMPT_PATH = Path(__file__).resolve().parent.parent / "prompts" / "evaluator.txt"
...
def goal_evaluator(state: TripState) -> dict:
    ...
    llm = get_llm()
    messages = [
        SystemMessage(content="You are a goal evaluation expert for a travel planning agent."),
